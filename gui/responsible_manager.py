...
class ResponsibleManager(ctk.CTkFrame):
    ...
    def _setup_ui(self):
        ...
        # Комбо для выбора организации по названию
        self.org_var = ctk.StringVar()
        org_names = [org[1] for org in self.organizations]
        self.org_combobox = ttk.Combobox(self, textvariable=self.org_var, values=org_names, state="readonly")
    ...
    def _on_select(self, event):
        ...
        if selected:
            ...
            if values[3] in self.org_combobox['values']:
